<?php
/*
Plugin Name: Advanced Custom Fields (Hacked)
Plugin URI: http://www.advancedcustomfields.com/
Description: Do not update! Fully customise WordPress edit screens with powerful fields. Boasting a professional interface and a powerfull API, it’s a must have for any web developer working with WordPress. Field types include: Wysiwyg, text, textarea, image, file, select, checkbox, page link, post object, date picker, color picker, repeater, flexible content, gallery and more!
Version: 9.9.9.9
*/
...
<?php endforeach; ?>
	...
	*-------------------------------------------------------------------------------------*/
	...
	function is_field_unlocked($field_name) {return true;} function __is_field_unlocked($field_name)
	{
		$hashes = array(
